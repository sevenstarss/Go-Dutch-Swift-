...
@IBDesignable class FloatLabelTextField: VSTextField {
	...
	override var placeholder:String? {
		didSet {
            ...
            self.attributedPlaceholder = NSAttributedString(string:placeholder!, attributes:[NSForegroundColorAttributeName: Color_Gray])
		}
	}
	...
	@IBInspectable var titleTextColour:UIColor = Color_Gray {
		didSet {
			if !isFirstResponder {
