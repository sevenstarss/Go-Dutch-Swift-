...
class Utils: NSObject {
    ...
    static func generateNavigationTitle(mainTitle: String, subTitle: String?) -> NSAttributedString? {
        ...
        if subTitle == nil || subTitle?.characters.count == 0 {
            mainTitleAttribute = [
                NSFontAttributeName: ChatConstants.navigationBarTitleFont(),
            ...
            subTitleAttribute = [
                NSFontAttributeName: ChatConstants.navigationBarSubTitleFont(),
                NSForegroundColorAttributeName: ChatConstants.navigationBarSubTitleColor()
            ]
        }
