...
class CreateGroupChannelSelectOptionViewController: UIViewController {
    ...
    private func selectDictinctOption() {
        ...
        self.distinctTextButton.titleLabel?.font = ChatConstants.distinctButtonSelected()
        self.nonDistinctTextButton.titleLabel?.font = ChatConstants.distinctButtonNormal()
    }
    ...
    private func selectNonDistinctOption() {
        ...
        self.distinctTextButton.titleLabel?.font = ChatConstants.distinctButtonNormal()
        self.nonDistinctTextButton.titleLabel?.font = ChatConstants.distinctButtonSelected()
    }
