...
//        self.setDefaultNavigationItems()
    ...
    private func setEditableNavigationItems() {
        ...
        leftBackItem.setTitleTextAttributes([NSFontAttributeName: ChatConstants.navigationBarButtonItemFont()], for: UIControlState.normal)
...
//        self.setDefaultNavigationItems()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if self.editableChannel == true {
            ...
            let leaveButton = MGSwipeButton(title: Bundle.sbLocalizedStringForKey(key: "LeaveButton"), backgroundColor: ChatConstants.leaveButtonColor())
            let hideButton = MGSwipeButton(title: Bundle.sbLocalizedStringForKey(key: "HideButton"), backgroundColor: ChatConstants.hideButtonColor())
            
            hideButton.titleLabel?.font = ChatConstants.hideButtonFont()
            leaveButton.titleLabel?.font = ChatConstants.leaveButtonFont()
